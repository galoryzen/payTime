                ...
                <div class="p-4 sm:w-1/2 lg:w-1/3">
                    <div class="border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                        <div class="p-6 hover:bg-sky-700 hover:text-white transition duration-300 ease-in">
                            <h2 class="text-2xl font-medium text-amber-400 mb-1">Pago de Matrícula</h2>
                            <h1 class="text-2xl font-semibold mb-3">29.09.2022 16:49</h1>
                            <h1 class="text-4xl font-semibold mb-3">$8.456.230</h1>
                            <h2 class="text-2xl font-medium text-green-600 mb-1">Aprobado</h2>
                        </div>
                    </div>
                </div>
                <div class="p-4 sm:w-1/2 lg:w-1/3">
