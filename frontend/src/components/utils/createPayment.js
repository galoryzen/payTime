...
export default function CreatePayment() {
  ...
  return (
    <div>
      <form
        class='mt-16 mx-auto w-8/12 text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-sky-800 dark:border-cyan-900'
        onSubmit={setForm}
      >
        ...
        <div class='flex flex-wrap -mx-3 mb-2'>
          ...
          <button
            className='w-full my-5 py-2 bg-amber-500 shadow-lg shadow-amber-500/50 hover:shadow-amber-500/40 text-lg text-white font-semibold rounded-lg'
            type='submit'
          >
            Hacer pago
          </button>
